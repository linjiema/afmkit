...
> **Install from GitHub** — afmkit is not on PyPI. Pin a tag (`@v0.6.0`)
> for reproducibility, or `@main` for the bleeding edge. See
> [What's new in v0.6.0](https://github.com/linjiema/afmkit/releases/tag/v0.6.0).
...
```bash
pip install "afmkit[all] @ git+https://github.com/linjiema/afmkit.git@v0.6.0"
```
...
```bash
pip install "afmkit @ git+https://github.com/linjiema/afmkit.git@v0.6.0"           # core only
pip install "afmkit[igor] @ git+https://github.com/linjiema/afmkit.git@v0.6.0"    # .ibw round-trip
pip install "afmkit[gui]  @ git+https://github.com/linjiema/afmkit.git@v0.6.0"    # Textual TUI
pip install "afmkit[plot] @ git+https://github.com/linjiema/afmkit.git@v0.6.0"    # matplotlib panel
```
...
```bash
pip install "afmkit[gui,plot] @ git+https://github.com/linjiema/afmkit.git@v0.6.0"
afmkit gui
...
Test count: 447 unit + 12 doctest (6 doctest marked `+SKIP` for examples
